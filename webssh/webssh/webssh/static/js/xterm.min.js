!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, i) {
      ...
      var r = i(13);
      ((t.IBufferService = r.createDecorator("BufferService")),
        (t.ICoreMouseService = r.createDecorator("CoreMouseService")),
        (t.ICoreService = r.createDecorator("CoreService")),
        (t.IDirtyRowService = r.createDecorator("DirtyRowService")),
        (t.IInstantiationService = r.createDecorator("InstantiationService")),
        (t.ILogService = r.createDecorator("LogService")),
        (t.IOptionsService = r.createDecorator("OptionsService")));
    },
    function (e, t, i) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 });
                      ...
                      e._listeners.push(t),
                      {
                        dispose: function () {
                          for (var i = 0; i < e._listeners.length; i++)
                            if (e._listeners[i] === t)
                              return void e._listeners.splice(i, 1);
                        },
                      }
                    );
                  }),
        ...
        a = (function (e) {
          ...
          return (
            ...
            (t.prototype.setFromCharData = function (e) {
              ...
              var t = !1;
              if (e[o.CHAR_DATA_CHAR_INDEX].length > 2) t = !0;
    ...
    function (e, t, i) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });
      var r = i(13);
      ((t.ICharSizeService = r.createDecorator("CharSizeService")),
        (t.IMouseService = r.createDecorator("MouseService")),
        (t.IRenderService = r.createDecorator("RenderService")),
        (t.ISelectionService = r.createDecorator("SelectionService")),
        (t.ISoundService = r.createDecorator("SoundService")));
    },
    function (e, t, i) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 });
    ...
    function (e, t, i) {
      ...
      ((t.isFirefox = !!~n.indexOf("Firefox")),
        ...
        (t.isMac = o(["Macintosh", "MacIntel", "MacPPC", "Mac68K"], s)),
        (t.isIpad = "iPad" === s),
        (t.isIphone = "iPhone" === s),
        (t.isWindows = o(["Windows", "Win16", "Win32", "WinCE"], s)),
          ...
          return (
            ...
            (e.prototype._refreshCharAtlas = function (e) {
              (this._scaledCharWidth <= 0 && this._scaledCharHeight <= 0) ||
                ((this._charAtlas = s.acquireCharAtlas(
                ...
                : (e.isInverse()
                    ? ((s = e.isBgDefault()
                      ...
                      (o = e.isFgDefault()
                        ? n.INVERTED_DEFAULT_COLOR
                        : e.getFgColor()))
                    : ((o = e.isBgDefault() ? r.DEFAULT_COLOR : e.getBgColor()),
                      (s = e.isFgDefault() ? r.DEFAULT_COLOR : e.getFgColor())),
                  (s +=
                    this._optionsService.options.drawBoldTextInBrightColors &&
                    e.isBold() &&
                    s < 8 &&
                    s !== n.INVERTED_DEFAULT_COLOR
                      ? 8
                      : 0),
                  (this._currentGlyphIdentifier.chars =
                    e.getChars() || r.WHITESPACE_CELL_CHAR),
                  (this._currentGlyphIdentifier.code =
                    e.getCode() || r.WHITESPACE_CELL_CODE),
                  ...
                  (this._charAtlas &&
                    this._charAtlas.draw(
                      ...
                      this._currentGlyphIdentifier,
                      t * this._scaledCellWidth + this._scaledCharLeft,
                      i * this._scaledCellHeight + this._scaledCharTop,
                    )) ||
                    this._drawUncachedChars(e, t, i));
            }),
              ...
              if (
                ...
                e.isBgDefault()
                  ...
                  : e.isBgRGB()
                    ? (this._ctx.fillStyle =
                        "rgb(" +
                        o.AttributeData.toColorRGB(e.getBgColor()).join(",") +
                        ")")
                    : (this._ctx.fillStyle =
                        this._colors.ansi[e.getBgColor()].css);
              else if (e.isFgDefault())
                this._ctx.fillStyle = this._colors.foreground.css;
              else if (e.isFgRGB())
                this._ctx.fillStyle =
                  "rgb(" +
                  o.AttributeData.toColorRGB(e.getFgColor()).join(",") +
                  ")";
              else {
                var r = e.getFgColor();
                (this._optionsService.options.drawBoldTextInBrightColors &&
    ...
    function (e, t, i) {
      ...
      function s(e, t, i) {
        t[r] === t
          ? t[n].push({ id: e, index: i })
          : ((t[n] = [{ id: e, index: i }]), (t[r] = t));
      }
        ...
        return (
          ...
          (e.prototype.getString = function (e) {
            ...
            return 2097152 & t
              ? this._combined[e]
              : 2097151 & t
                ? r.stringFromCodePoint(2097151 & t)
                : "";
          }),
          (e.prototype.loadCell = function (e, t) {
            var i = e * a;
            return (
              (t.content = this._data[i + 0]),
              (t.fg = this._data[i + 1]),
              (t.bg = this._data[i + 2]),
          ...
          (e.prototype.addCodepointToCell = function (e, t) {
            ...
            2097152 & i
              ? (this._combined[e] += r.stringFromCodePoint(t))
              : (2097151 & i
                  ? ((this._combined[e] =
                      r.stringFromCodePoint(2097151 & i) +
                      r.stringFromCodePoint(t)),
                    (i &= -2097152),
                    (i |= 2097152))
                  : (i = t | (1 << 22)),
                (this._data[e * a + 0] = i));
          ...
          (e.prototype.insertCells = function (e, t, i) {
            if (((e %= this.length), t < this.length - e)) {
              for (
                var r = new s.CellData(), n = this.length - e - t - 1;
                n >= 0;
                --n
              )
              ...
              if (e > this.length) {
                ...
                (this.length &&
                  (e * a < this._data.length
                    ? i.set(this._data.subarray(0, e * a))
                    : i.set(this._data)),
                  (this._data = i));
                for (var r = this.length; r < e; ++r) this.setCell(r, t);
              } else if (e) {
                ((i = new Uint32Array(e * a)).set(
                  this._data.subarray(0, e * a),
                ),
                  (this._data = i));
          ...
          (e.prototype.clone = function () {
            var t = new e(0);
            for (var i in ((t._data = new Uint32Array(this._data)),
            (t.length = this.length),
            this._combined))
              t._combined[i] = this._combined[i];
            return ((t.isWrapped = this.isWrapped), t);
          }),
          (e.prototype.getTrimmedLength = function () {
            for (var e = this.length - 1; e >= 0; --e)
              if (4194303 & this._data[e * a + 0])
                return e + (this._data[e * a + 0] >> 22);
            return 0;
          }),
          ...
          (e.prototype.translateToString = function (e, t, i) {
            ...
            for (var s = ""; t < i; ) {
              var o = this._data[t * a + 0],
                c = 2097151 & o;
              ((s +=
                2097152 & o
                  ? this._combined[t]
                  : c
                    ? r.stringFromCodePoint(c)
    ...
    function (e, t, i) {
      ...
      ((t.wcwidth = (function (e) {
        ...
        (r.fill(s, 1),
          (s[0] = e.nul),
          r.fill(s, e.control, 1, 32),
          r.fill(s, e.control, 127, 160),
          r.fill(s, 2, 4352, 4448),
          (s[9001] = 2),
          (s[9002] = 2),
          r.fill(s, 2, 11904, 42192),
          (s[12351] = 1),
          r.fill(s, 2, 44032, 55204),
          r.fill(s, 2, 63744, 64256),
          r.fill(s, 2, 65040, 65050),
          r.fill(s, 2, 65072, 65136),
          r.fill(s, 2, 65280, 65377),
          r.fill(s, 2, 65504, 65511));
          ...
          return (
            (e.fromArray = function (t) {
              ...
              for (var r = t[0] instanceof Array ? 1 : 0; r < t.length; ++r) {
                ...
                if (n instanceof Array)
                  for (var s = 0; s < n.length; ++s) i.addSubParam(n[s]);
                else i.addParam(n);
              }
              return i;
            }),
            ...
            (e.prototype.toArray = function () {
              for (var e = [], t = 0; t < this.length; ++t) {
                ...
                var i = this._subParamsIdx[t] >> 8,
                  r = 255 & this._subParamsIdx[t];
                r - i > 0 &&
                  e.push(Array.prototype.slice.call(this._subParams, i, r));
              }
              return e;
            }),
    ...
    function (e, t, i) {
        ...
        s = (function () {
          ...
          return (
            ...
            (e.prototype._put = function (e, t, i) {
              ...
              if (r) for (var s = r.length - 1; s >= 0; s--) r[s].put(e, t, i);
              else this._handlerFb(this._id, "PUT", n.utf32ToString(e, t, i));
            }),
      ...
      var o = (function () {
        ...
        return (
          ...
          (e.prototype.put = function (e, t, i) {
            this._hitLimit ||
              ((this._data += n.utf32ToString(e, t, i)),
    ...
    function (e, t, i) {
            ...
            (e.prototype.hook = function (e, t) {
              if (
                ...
                for (var i = this._active.length - 1; i >= 0; i--)
                  this._active[i].hook(t);
              else this._handlerFb(this._ident, "HOOK", t);
            }),
            (e.prototype.put = function (e, t, i) {
              if (this._active.length)
                for (var n = this._active.length - 1; n >= 0; n--)
                  this._active[n].put(e, t, i);
              else
                this._handlerFb(this._ident, "PUT", r.utf32ToString(e, t, i));
            }),
      ...
      var c = (function () {
        ...
        return (
          ...
          (e.prototype.put = function (e, t, i) {
            this._hitLimit ||
              ((this._data += r.utf32ToString(e, t, i)),
            ...
            return (
              this._hitLimit
                ...
                : e &&
                  (t = this._handler(
                    this._data,
                    this._params ? this._params : new n.Params(),
                  )),
              (this._params = void 0),
              (this._data = ""),
              (this._hitLimit = !1),
      ...
      ((t.acquireCharAtlas = function (e, t, i, o, a) {
        ...
        (t.removeTerminalFromCache = function (e) {
          for (var t = 0; t < s.length; t++) {
            ...
            if (-1 !== i) {
              1 === s[t].ownedBy.length
                ? (s[t].atlas.dispose(), s.splice(t, 1))
                : s[t].ownedBy.splice(i, 1);
              break;
            }
          }
        }));
      ...
      var h = (function () {
        ...
        return (
          (e.prototype.setTheme = function (e) {
            (void 0 === e && (e = {}),
              (this.colors.foreground = this._parseColor(e.foreground, r)),
              (this.colors.background = this._parseColor(e.background, n)),
              (this.colors.cursor = this._parseColor(e.cursor, s, !0)),
              (this.colors.cursorAccent = this._parseColor(
                e.cursorAccent,
                o,
                !0,
              )),
              (this.colors.selection = this._parseColor(e.selection, a, !0)),
        ...
        return (
          ...
          (e.prototype.getJoinedCharacters = function (e) {
            ...
            for (
              ...
              if (
                ...
                if (this._workCell.fg !== c || this._workCell.bg !== l) {
                  if (h - n > 1)
                    for (
                      var u = this._getJoinedRanges(r, a, s, t, n), f = 0;
                      f < u.length;
                      f++
                    )
                      i.push(u[f]);
            ...
            if (this._bufferService.cols - n > 1)
              for (
                u = this._getJoinedRanges(r, a, s, t, n), f = 0;
                f < u.length;
                f++
              )
                i.push(u[f]);
          ...
          (e.prototype._getJoinedRanges = function (t, i, r, n, s) {
            for (
              ...
              for (
                var l = this._characterJoiners[c].handler(o), h = 0;
                h < l.length;
                h++
              )
          ...
          (e.prototype._stringRangesToCellRanges = function (e, t, i) {
            ...
            if (a) {
              for (var c = i; c < this._bufferService.cols; c++) {
                var l = t.getWidth(c),
                  h = t.getString(c).length || o.WHITESPACE_CELL_CHAR.length;
                if (0 !== l) {
    ...
    function (e, t, i) {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.getCoords = function (e, t, i, n, s, o, a, c) {
          if (s) {
            var l = r(e, t);
            if (l)
              return (
        ...
        o = (function () {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "parser", {
              get: function () {
                return (
                  this._parser || (this._parser = new h(this._core)),
                  this._parser
                );
              },
              enumerable: !0,
    ...
    function (e, t, i) {
      ...
      var s = i(34),
        ...
        B = i(73),
        F = i(74),
        j = "undefined" != typeof window ? window.document : null,
        W = (function (e) {
          function t(t) {
            void 0 === t && (t = {});
            ...
            return (
              ...
              (i._keyDownHandled = !1),
              (i._blankLine = null),
              (i._onCursorMove = new C.EventEmitter()),
              (i._onData = new C.EventEmitter()),
              (i._onKey = new C.EventEmitter()),
              (i._onLineFeed = new C.EventEmitter()),
              (i._onRender = new C.EventEmitter()),
              (i._onResize = new C.EventEmitter()),
              (i._onScroll = new C.EventEmitter()),
              (i._onSelectionChange = new C.EventEmitter()),
              (i._onTitleChange = new C.EventEmitter()),
              (i._onFocus = new C.EventEmitter()),
              (i._onBlur = new C.EventEmitter()),
              (i.onA11yCharEmitter = new C.EventEmitter()),
              (i.onA11yTabEmitter = new C.EventEmitter()),
              (i._instantiationService = new I.InstantiationService()),
              (i.optionsService = new x.OptionsService(t)),
              i._instantiationService.setService(
                A.IOptionsService,
                i.optionsService,
              ),
              (i._bufferService = i._instantiationService.createInstance(
                T.BufferService,
              )),
              i._instantiationService.setService(
                A.IBufferService,
              ...
              (i._logService = i._instantiationService.createInstance(
                P.LogService,
              )),
              i._instantiationService.setService(A.ILogService, i._logService),
              (i._coreService = i._instantiationService.createInstance(
                O.CoreService,
                function () {
              ...
              i._coreService.onData(function (e) {
                return i._onData.fire(e);
              }),
              (i._coreMouseService = i._instantiationService.createInstance(
                B.CoreMouseService,
              )),
              i._instantiationService.setService(
                A.ICoreMouseService,
              ...
              (i._dirtyRowService = i._instantiationService.createInstance(
                H.DirtyRowService,
              )),
              i._instantiationService.setService(
                A.IDirtyRowService,
          ...
          return (
            ...
            (t.prototype.dispose = function () {
              this._isDisposed ||
                ...
                this._renderService && this._renderService.dispose(),
            ...
            (t.prototype._setup = function () {
              ...
              ((this._parent = j ? j.body : null),
                ...
                (this.glevel = 0),
                (this.charsets = [null]),
                (this.curAttrData = S.DEFAULT_ATTR_DATA.clone()),
                ...
                (this.linkifier =
                  this.linkifier ||
                  new u.Linkifier(this._bufferService, this._logService)),
                this.options.windowsMode &&
                  (this._windowsMode = w.applyWindowsMode(this)));
            }),
            ...
            (t.prototype._setupOptionsListeners = function () {
              ...
              this.optionsService.onOptionChange(function (t) {
                switch (t) {
                  case "fontFamily":
                  case "fontSize":
                    (e._renderService && e._renderService.clear(),
                      e._charSizeService && e._charSizeService.measure());
                    break;
                  ...
                  case "scrollback":
                    (e.buffers.resize(e.cols, e.rows),
                      e.viewport && e.viewport.syncScrollArea());
                    break;
                  case "screenReaderMode":
                    e.optionsService.options.screenReaderMode
                      ? !e._accessibilityManager &&
                        e._renderService &&
                        (e._accessibilityManager = new y.AccessibilityManager(
                          e,
                          e._renderService,
                        ))
                      : e._accessibilityManager &&
                        (e._accessibilityManager.dispose(),
                  ...
                  case "windowsMode":
                    e.optionsService.options.windowsMode
                      ? e._windowsMode ||
                        (e._windowsMode = w.applyWindowsMode(e))
                      : e._windowsMode &&
                        (e._windowsMode.dispose(), (e._windowsMode = void 0));
                }
              });
            }),
            ...
            (t.prototype.open = function (e) {
              ...
              ((this._viewportElement = j.createElement("div")),
                this._viewportElement.classList.add("xterm-viewport"),
                i.appendChild(this._viewportElement),
                (this._viewportScrollArea = j.createElement("div")),
                this._viewportScrollArea.classList.add("xterm-scroll-area"),
                this._viewportElement.appendChild(this._viewportScrollArea),
                (this.screenElement = j.createElement("div")),
                this.screenElement.classList.add("xterm-screen"),
                (this._helperContainer = j.createElement("div")),
                this._helperContainer.classList.add("xterm-helpers"),
                this.screenElement.appendChild(this._helperContainer),
                i.appendChild(this.screenElement),
                (this.textarea = j.createElement("textarea")),
                ...
                (this._compositionView = j.createElement("div")),
                ...
                (this._colorManager = new E.ColorManager(
                  j,
            ...
            (t.prototype.bindMouse = function () {
              ...
              function r(e) {
                var i, r, n;
                if (
                  !(i = t._mouseService.getRawByteCoords(
                    e,
                    t.screenElement,
                    t.cols,
                    t.rows,
              ...
              (this._coreMouseService.onProtocolChange(function (t) {
                ((e.mouseEvents = t),
                  ...
                  8 & t
                    ? n.mousemove ||
                      (i.addEventListener("mousemove", l), (n.mousemove = l))
                    : (i.removeEventListener("mousemove", n.mousemove),
                      (n.mousemove = null)),
                  16 & t
                    ? n.wheel || (i.addEventListener("wheel", o), (n.wheel = o))
                    : (i.removeEventListener("wheel", n.wheel),
                      (n.wheel = null)),
                  2 & t
                    ? n.mouseup || (n.mouseup = s)
                    : (e._document.removeEventListener("mouseup", n.mouseup),
                      (n.mouseup = null)),
                  4 & t
                ...
                (this._coreMouseService.activeProtocol =
                  this._coreMouseService.activeProtocol),
                this.register(
                  d.addDisposableDomListener(i, "mousedown", function (t) {
                    if (
                      (t.preventDefault(),
                      e.focus(),
                      e.mouseEvents &&
                      ...
                      return (
                        r(t),
                        n.mouseup &&
                          e._document.addEventListener("mouseup", n.mouseup),
                        n.mousedrag &&
                ...
                this.register(
                  d.addDisposableDomListener(i, "wheel", function (t) {
                    if (n.wheel);
                ...
                this.register(
                  d.addDisposableDomListener(i, "touchstart", function (t) {
                    if (!e.mouseEvents)
                      return (e.viewport.onTouchStart(t), e.cancel(t));
                  }),
                ),
                this.register(
                  d.addDisposableDomListener(i, "touchmove", function (t) {
                    if (!e.mouseEvents)
            ...
            (t.prototype.resize = function (e, t) {
              isNaN(e) ||
                ...
                (e !== this.cols || t !== this.rows
                  ? (e < T.MINIMUM_COLS && (e = T.MINIMUM_COLS),
                    t < T.MINIMUM_ROWS && (t = T.MINIMUM_ROWS),
                    this.buffers.resize(e, t),
                    this._bufferService.resize(e, t),
                    this.buffers.setupTabStops(this.cols),
                    this._charSizeService && this._charSizeService.measure(),
              ...
              if (0 !== this.buffer.ybase || 0 !== this.buffer.y) {
                ...
                for (var e = 1; e < this.rows; e++)
                  this.buffer.lines.push(
                    this.buffer.getBlankLine(S.DEFAULT_ATTR_DATA),
                  );
                (this.refresh(0, this.rows - 1),
                  this._onScroll.fire(this.buffer.ydisp));
              }
            ...
            (t.prototype.reset = function () {
              ...
              (this._setup(),
                ...
                this._selectionService && this._selectionService.reset(),
                (this._customKeyEventHandler = e),
                (this._inputHandler = t),
                (this.cursorState = i),
                (this._userScrolling = r),
                this.refresh(0, this.rows - 1),
      ...
      var s = i(5),
        ...
        a = (function () {
          ...
          return (
            ...
            (e = r(
              [
                n(2, o.IBufferService),
                n(3, o.IOptionsService),
                n(4, s.ICharSizeService),
                n(5, o.ICoreService),
              ],
              e,
            ))
        ...
        f = (function (e) {
          function t(t, i, r, n, s, o, a) {
            ...
            return (
              ...
              (l.scrollBarWidth =
                l._viewportElement.offsetWidth - l._scrollArea.offsetWidth ||
                u),
              l.register(
          ...
          return (
            ...
            (t = s(
              [
                o(3, h.IBufferService),
                o(4, h.IOptionsService),
                o(5, l.ICharSizeService),
                o(6, l.IRenderService),
              ],
              t,
            ))
          );
    ...
    function (e, t, i) {
      ...
      function o(e, t, i) {
        var r = i.getBoundingClientRect(),
          n = e.clientX - r.left - 10,
          s = e.clientY - r.top - 10;
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.handlePasteEvent = function (e, t, i, r) {
          (e.stopPropagation(),
            e.clipboardData &&
              s(e.clipboardData.getData("text/plain"), t, i, r));
        }),
        (t.paste = s),
        (t.moveTextAreaUnderMouseCursor = o),
        (t.rightClickHandler = function (e, t, i, r, n) {
          (o(e, t, i),
            n && !r.isClickInSelection(e) && r.selectWordAtCursor(e),
              ...
              if (e) {
                ...
                switch (((this._data = new Uint32Array(0)), t)) {
                  ...
                  case " q":
                    ...
                    return (
                      (r -= this._optionsService.options.cursorBlink ? 1 : 0),
                      this._coreService.triggerDataEvent(
                        s.C0.ESC + "P1$r" + r + " q" + s.C0.ESC + "\\",
                      )
                    );
                  default:
        ...
        C = (function (e) {
          function t(t, i, r, n, a, l, h, f) {
            ...
            ((d._terminal = t),
              (d._bufferService = i),
              (d._coreService = r),
              (d._dirtyRowService = n),
              (d._logService = a),
              (d._optionsService = l),
              (d._coreMouseService = h),
              (d._parser = f),
              (d._parseBuffer = new Uint32Array(4096)),
              (d._stringDecoder = new u.StringToUtf32()),
              (d._utf8Decoder = new u.Utf8ToUtf32()),
              (d._workCell = new p.CellData()),
              (d._onCursorMove = new _.EventEmitter()),
              (d._onLineFeed = new _.EventEmitter()),
              (d._onScroll = new _.EventEmitter()),
              d.register(d._parser),
              d._parser.setCsiHandlerFallback(function (e, t) {
          ...
          return (
            ...
            (t.prototype.parse = function (e) {
              ...
              (((t = this._bufferService.buffer).x === i && t.y === r) ||
            ...
            (t.prototype.print = function (e, t, i) {
              ...
              for (var v = t; v < i; ++v) {
                ...
                if (
                  (c &&
                    this._terminal.onA11yCharEmitter.fire(
                      u.stringFromCodePoint(r),
                    ),
                  n || !s.x)
                ) {
                  if (s.x + n - 1 >= l)
                    if (h)
                      ((s.x = 0),
                        s.y++,
                        s.y === s.scrollBottom + 1
                          ? (s.y--, this._terminal.scroll(!0))
                          : (s.y >= this._bufferService.rows &&
                              (s.y = this._bufferService.rows - 1),
                            (s.lines.get(s.y).isWrapped = !0)),
                        (p = s.lines.get(s.y + s.ybase)));
                    else if (((s.x = l - 1), 2 === n)) continue;
                  if (
                    (f &&
                      (p.insertCells(s.x, n, s.getNullCell(_)),
                      2 === p.getWidth(l - 1) &&
                    ...
                    p.setCellFromCodePoint(s.x++, r, n, _.fg, _.bg),
                    n > 0)
                  )
                    for (; --n; )
                      p.setCellFromCodePoint(s.x++, 0, 0, _.fg, _.bg);
                } else
                  p.getWidth(s.x - 1)
                    ? p.addCodepointToCell(s.x - 1, r)
                    : p.addCodepointToCell(s.x - 2, r);
              }
              (i &&
                (p.loadCell(s.x - 1, this._workCell),
              ...
              if (!(this._bufferService.buffer.x >= this._bufferService.cols)) {
                ...
                ((this._bufferService.buffer.x =
                  ...
                  this._optionsService.options.screenReaderMode &&
                    this._terminal.onA11yTabEmitter.fire(
            ...
            (t.prototype.eraseInDisplay = function (e) {
              ...
              switch ((this._restrictCursor(), e.params[0])) {
                ...
                case 1:
                  for (
                    t = this._bufferService.buffer.y,
                      ...
                      this._bufferService.buffer.x + 1 >=
                        this._bufferService.cols &&
                        (this._bufferService.buffer.lines.get(t + 1).isWrapped =
                          !1);
                    t--;
                  )
                    this._resetBufferLine(t);
                ...
                case 3:
                  ...
                  i > 0 &&
                    (this._bufferService.buffer.lines.trimStart(i),
                    (this._bufferService.buffer.ybase = Math.max(
                      this._bufferService.buffer.ybase - i,
                      0,
                    )),
                    (this._bufferService.buffer.ydisp = Math.max(
                      this._bufferService.buffer.ydisp - i,
                      0,
                    )),
            ...
            (t.prototype.insertLines = function (e) {
              ...
              if (!(i.y > i.scrollBottom || i.y < i.scrollTop)) {
                for (
                  var r = i.y + i.ybase,
                    n = this._bufferService.rows - 1 - i.scrollBottom,
                    s = this._bufferService.rows - 1 + i.ybase - n + 1;
                  t--;
                )
                ...
                (this._dirtyRowService.markRangeDirty(i.y, i.scrollBottom),
                  (i.x = 0));
              }
            }),
            (t.prototype.deleteLines = function (e) {
              ...
              if (!(i.y > i.scrollBottom || i.y < i.scrollTop)) {
                var r,
                  n = i.y + i.ybase;
                for (
                  r = this._bufferService.rows - 1 - i.scrollBottom,
                    r = this._bufferService.rows - 1 + i.ybase - r;
                  t--;
                )
                  (i.lines.splice(n, 1),
                    i.lines.splice(
            ...
            (t.prototype.scrollDown = function (e) {
              for (
                ...
                (i.lines.splice(i.ybase + i.scrollBottom, 1),
                  i.lines.splice(
                    i.ybase + i.scrollTop,
                    0,
                    i.getBlankLine(f.DEFAULT_ATTR_DATA),
                  ));
              this._dirtyRowService.markRangeDirty(i.scrollTop, i.scrollBottom);
            }),
            (t.prototype.scrollLeft = function (e) {
              ...
              if (!(t.y > t.scrollBottom || t.y < t.scrollTop)) {
                for (
                  var i = e.params[0] || 1, r = t.scrollTop;
                  r <= t.scrollBottom;
                  ++r
                ) {
                  ...
                  (n.deleteCells(
                    0,
                    i,
                    t.getNullCell(this._terminal.eraseAttrData()),
                  ),
                    (n.isWrapped = !1));
                }
                this._dirtyRowService.markRangeDirty(
            ...
            (t.prototype.repeatPrecedingCharacter = function (e) {
              if (this._parser.precedingCodepoint) {
                for (
                  var t = e.params[0] || 1, i = new Uint32Array(t), r = 0;
                  r < t;
                  ++r
                )
                  i[r] = this._parser.precedingCodepoint;
              ...
              return (
                38 === r[0]
                  ? 2 === r[1]
                    ? ((i.fg |= 50331648),
                      (i.fg &= -16777216),
                      (i.fg |= v.AttributeData.fromColorRGB([
                        r[3],
                        r[4],
                        r[5],
                      ])))
                    : 5 === r[1] &&
                      ((i.fg &= -50331904), (i.fg |= 33554432 | (255 & r[3])))
                  : 48 === r[0] &&
                    (2 === r[1]
                      ? ((i.bg |= 50331648),
                        (i.bg &= -16777216),
                        (i.bg |= v.AttributeData.fromColorRGB([
                          r[3],
                          r[4],
                          r[5],
                        ])))
            ...
            (t.prototype.charAttributes = function (e) {
              if (1 === e.length && 0 === e.params[0])
                return (
                  (this._terminal.curAttrData.fg = f.DEFAULT_ATTR_DATA.fg),
                  void (this._terminal.curAttrData.bg = f.DEFAULT_ATTR_DATA.bg)
                );
              for (
                  ...
                  : t >= 40 && t <= 47
                    ...
                    : t >= 90 && t <= 97
                      ...
                      : t >= 100 && t <= 107
                        ...
                        : 0 === t
                          ? ((r.fg = f.DEFAULT_ATTR_DATA.fg),
                            (r.bg = f.DEFAULT_ATTR_DATA.bg))
                          : 1 === t
                            ? (r.fg |= 134217728)
                            : 3 === t
                              ? (r.bg |= 67108864)
              ...
              switch (e.params[0]) {
                ...
                case 6:
                  var t = this._bufferService.buffer.y + 1,
                    i = this._bufferService.buffer.x + 1;
                  this._coreService.triggerDataEvent(
                    s.C0.ESC + "[" + t + ";" + i + "R",
                  );
              }
            ...
            (t.prototype.softReset = function (e) {
              ((this._terminal.cursorHidden = !1),
                ...
                (this._bufferService.buffer.scrollBottom =
                  this._bufferService.rows - 1),
                (this._terminal.curAttrData = f.DEFAULT_ATTR_DATA.clone()),
                (this._bufferService.buffer.x = this._bufferService.buffer.y =
                  0),
            ...
            (t.prototype.setScrollRegion = function (e) {
              ...
              ((e.length < 2 ||
                ...
                (t = this._bufferService.rows),
                t > i &&
                  ((this._bufferService.buffer.scrollTop = i - 1),
            ...
            (t.prototype.tabSet = function () {
              this._bufferService.buffer.tabs[this._bufferService.buffer.x] =
                !0;
            }),
            (t.prototype.reverseIndex = function () {
              ...
              if (e.y === e.scrollTop) {
                ...
                (e.lines.shiftElements(e.y + e.ybase, t, 1),
                  e.lines.set(
                    e.y + e.ybase,
                    e.getBlankLine(this._terminal.eraseAttrData()),
                  ),
                  this._dirtyRowService.markRangeDirty(
                    e.scrollTop,
                    e.scrollBottom,
            ...
            (t.prototype.screenAlignmentPattern = function () {
              ...
              ((e.content = (1 << 22) | "E".charCodeAt(0)),
                (e.fg = this._terminal.curAttrData.fg),
                (e.bg = this._terminal.curAttrData.bg));
              var t = this._bufferService.buffer;
              this._setCursor(0, 0);
    ...
    function (e, t, i) {
      ...
      t.VT500_TRANSITION_TABLE = (function () {
        ...
        var s,
          o = i(0, 14);
        for (s in (e.setDefault(1, 0), e.addMany(r, 0, 2, 0), o))
          (e.addMany([24, 26, 153, 154], s, 3, 0),
            e.addMany(i(128, 144), s, 3, 0),
            e.addMany(i(144, 152), s, 3, 0),
            e.add(156, s, 0, 0),
            e.add(27, s, 11, 1),
            e.add(157, s, 4, 8),
            e.addMany([152, 158, 159], s, 0, 7),
            e.add(155, s, 11, 3),
            e.add(144, s, 11, 9));
        return (
          e.addMany(n, 0, 3, 0),
      ...
      var u = (function (e) {
        function i(i) {
          ...
          return (
            (r.TRANSITIONS = i),
            (r.initialState = 0),
            (r.currentState = r.initialState),
            (r._params = new a.Params()),
            r._params.addParam(0),
            (r._collect = 0),
            (r.precedingCodepoint = 0),
            (r._printHandlerFb = function (e, t, i) {}),
            ...
            (r._printHandler = r._printHandlerFb),
            (r._executeHandlers = Object.create(null)),
            (r._csiHandlers = Object.create(null)),
            (r._escHandlers = Object.create(null)),
            (r._oscParser = new c.OscParser()),
            (r._dcsParser = new l.DcsParser()),
            (r._errorHandler = r._errorHandlerFb),
            r.setEscHandler({ final: "\\" }, function () {}),
            r
          );
        }
        return (
          n(i, e),
          (i.prototype._identifier = function (e, t) {
            void 0 === t && (t = [64, 126]);
            var i = 0;
            if (e.prefix) {
          ...
          (i.prototype.parse = function (e, t) {
            for (
              ...
              switch ((r = l[(n << 8) | ((i = e[h]) < 160 ? i : 160)]) >> 4) {
                ...
                case 7:
                  for (
                    var f = this._csiHandlers[(a << 8) | i],
                      _ = f ? f.length - 1 : -1;
                    _ >= 0 && !1 === f[_](c);
                    _--
                  );
                  (_ < 0 && this._csiHandlerFb((a << 8) | i, c),
                    (this.precedingCodepoint = 0));
                  break;
                case 8:
                  do {
                ...
                case 10:
                  for (
                    var d = this._escHandlers[(a << 8) | i],
                      p = d ? d.length - 1 : -1;
                    p >= 0 && !1 === d[p]();
                    p--
                  );
                  (p < 0 && this._escHandlerFb((a << 8) | i),
                    (this.precedingCodepoint = 0));
                  break;
                case 11:
        ...
        _ = (function (e) {
          function t(t, i, r, n, h) {
            ...
            ((u._colors = t),
              (u._terminal = i),
              (u.bufferService = r),
              (u._charSizeService = n),
              (u.optionsService = h),
              (u._id = f++));
            var _ = u._terminal.options.allowTransparency;
            return (
              (u._characterJoinerRegistry = new l.CharacterJoinerRegistry(r)),
              (u._renderLayers = [
                new s.TextRenderLayer(
                  u._terminal.screenElement,
                  0,
                  u._colors,
                  u._characterJoinerRegistry,
                  _,
                  u._id,
                  r,
                  h,
                ),
                new o.SelectionRenderLayer(
                  u._terminal.screenElement,
                  1,
                  u._colors,
                  u._id,
                ...
                new c.LinkRenderLayer(
                  ...
                  u._colors,
                  u._id,
                  u._terminal.linkifier,
                  r,
                  h,
                ),
                new a.CursorRenderLayer(
                  u._terminal.screenElement,
                  3,
                  u._colors,
                  u._terminal,
              ...
              (u._devicePixelRatio = window.devicePixelRatio),
              u._updateDimensions(),
              u.onOptionsChanged(),
              u
            );
        ...
        u = (function (e) {
          ...
          return (
            ...
            (t.prototype._forEachCell = function (e, t, i, r) {
              for (var n = e; n <= t; n++)
                for (
                  var s = n + this._bufferService.buffer.ydisp,
                    o = this._bufferService.buffer.lines.get(s),
                    a = i ? i.getJoinedCharacters(s) : [],
                    h = 0;
                  ...
                  if (0 !== u.getWidth()) {
                    ...
                    (!f &&
                      ...
                      _ < o.length - 1 &&
                      o.getCodePoint(_ + 1) === c.NULL_CELL_CODE &&
                    ...
                    ? (h = e.isFgDefault()
                        ...
                        : e.isFgRGB()
                          ? "rgb(" +
                            ...
                            ")"
                          : i._colors.ansi[e.getFgColor()].css)
                    : e.isBgRGB()
                      ? (h =
                          "rgb(" +
                          ...
                          ")")
                      : e.isBgPalette() &&
                        (h = i._colors.ansi[e.getBgColor()].css),
                    null === c && ((s = t), (o = l)),
                    l !== o
                      ? ((r.fillStyle = c || ""),
                        i._fillCells(s, o, n - s, 1),
                        (s = t),
                        (o = l))
                      : c !== h &&
                        ((r.fillStyle = c || ""),
                        i._fillCells(s, o, t - s, 1),
                        (s = t),
                        (o = l)),
                    (c = h));
                }),
                null !== c &&
                  ((r.fillStyle = c), this._fillCells(s, o, n - s, 1)),
                r.restore());
            }),
            (t.prototype._drawForeground = function (e, t) {
              ...
              this._forEachCell(
                ...
                function (e, t, r) {
                  if (
                    !e.isInvisible() &&
                    (i._drawChars(e, t, r), e.isUnderline())
                  ) {
                    if ((i._ctx.save(), e.isInverse()))
                      e.isBgDefault()
                        ...
                        : e.isBgRGB()
                          ? (i._ctx.fillStyle =
                              ...
                              ")")
                          : (i._ctx.fillStyle =
                              i._colors.ansi[e.getBgColor()].css);
                    else if (e.isFgDefault())
                      i._ctx.fillStyle = i._colors.foreground.css;
                    else if (e.isFgRGB())
                      i._ctx.fillStyle =
                        "rgb(" +
                        a.AttributeData.toColorRGB(e.getFgColor()).join(",") +
                      ...
                      var n = e.getFgColor();
                      (i._optionsService.options.drawBoldTextInBrightColors &&
                        e.isBold() &&
                        n < 8 &&
                        (n += 8),
                        (i._ctx.fillStyle = i._colors.ansi[n].css));
                    }
                    (i._fillBottomLineAtCells(t, r, e.getWidth()),
                      i._ctx.restore());
                  }
                },
              );
    ...
    function (e, t, i) {
      ...
      var p = (function (e) {
        function t(t, i) {
          var r = e.call(this) || this;
          ((r._config = i),
            (r._drawToCacheCount = 0),
            (r._glyphsWaitingOnBitmap = []),
            (r._bitmapCommitTimeout = null),
            (r._bitmap = null),
            (r._cacheCanvas = t.createElement("canvas")),
            (r._cacheCanvas.width = u),
            (r._cacheCanvas.height = f),
            (r._cacheCtx = h.throwIfFalsy(
              r._cacheCanvas.getContext("2d", { alpha: !0 }),
            )));
          var n = t.createElement("canvas");
          ((n.width = r._config.scaledCharWidth),
            (n.height = r._config.scaledCharHeight),
            (r._tmpCtx = h.throwIfFalsy(
              n.getContext("2d", { alpha: r._config.allowTransparency }),
            )),
            (r._width = Math.floor(u / r._config.scaledCharWidth)),
            (r._height = Math.floor(f / r._config.scaledCharHeight)));
        ...
        return (
          ...
          (t.prototype._getForegroundColor = function (e) {
            return e.fg === s.INVERTED_DEFAULT_COLOR
              ? this._config.colors.background
              : e.fg < 256
          ...
          (t.prototype._drawToCache = function (e, t) {
            ...
            ((this._tmpCtx.font =
              ...
              e.dim && (this._tmpCtx.globalAlpha = s.DIM_OPACITY),
            ...
            var o = this._tmpCtx.getImageData(
                0,
                0,
                this._config.scaledCharWidth,
                this._config.scaledCharHeight,
          ...
          (t.prototype._generateBitmap = function () {
            ...
            ((this._glyphsWaitingOnBitmap = []),
              window.createImageBitmap(this._cacheCanvas).then(function (i) {
                e._bitmap = i;
    ...
    function (e, t, i) {
      ...
      var s = (function (e) {
        ...
        return (
          ...
          (t.prototype.onSelectionChanged = function (e, t, i) {
            if (this._didStateChange(e, t, i, this._bufferService.buffer.ydisp))
              if ((this._clearAll(), e && t)) {
                var r = e[1] - this._bufferService.buffer.ydisp,
                  n = t[1] - this._bufferService.buffer.ydisp,
                  s = Math.max(r, 0),
                  o = Math.min(n, this._bufferService.rows - 1);
                if (!(s >= this._bufferService.rows || o < 0)) {
                  if (((this._ctx.fillStyle = this._colors.selection.css), i)) {
                    ...
                    if (
                      (this._fillCells(0, s + 1, this._bufferService.cols, u),
                      s !== o)
                    ) {
          ...
          return (
            ...
            (t.prototype._render = function (e) {
              if (this._terminal.cursorState && !this._terminal.cursorHidden) {
                ...
                if (i < 0 || i >= this._bufferService.rows) this._clearCursor();
                else if (
                  ...
                  if (
                    ...
                    (this._ctx.save(),
                      this._cursorRenderers[
                        this._optionsService.options.cursorStyle || "block"
                      ](this._bufferService.buffer.x, i, this._cell),
                      this._ctx.restore(),
                      (this._state.x = this._bufferService.buffer.x),
                      (this._state.y = i),
                      (this._state.isFocused = !1),
            ...
            (void 0 === e && (e = 600),
              ...
              (this._blinkStartTimeout = setTimeout(function () {
                if (t._animationTimeRestarted) {
                  ...
                  if (((t._animationTimeRestarted = null), e > 0))
          ...
          return (
            ...
            (t.prototype._clearCurrentLink = function () {
              if (this._state) {
                ...
                (e > 0 &&
                  this._clearCells(0, this._state.y1 + 1, this._state.cols, e),
        ...
        s = (function () {
          function e(e, t) {
            ((this._bufferService = e),
              ...
              (this._onLinkHover = new n.EventEmitter()),
              (this._onLinkLeave = new n.EventEmitter()),
              (this._onLinkTooltip = new n.EventEmitter()),
          ...
          return (
            ...
            (e.prototype.linkifyRows = function (t, i) {
              ...
              this._mouseZoneManager &&
                ...
                this._mouseZoneManager.clearAll(t, i),
                ...
                if (!(t >= e.lines.length)) {
                  for (
                    var i =
                        ...
                        1,
                      r = Math.ceil(2e3 / this._bufferService.cols),
                      n = this._bufferService.buffer.iterator(!1, t, i, r, r);
                    n.hasNext();
                  )
                    for (
                      var s = n.next(), o = 0;
            ...
            (e.prototype._doLinkifyRow = function (e, t, i) {
              for (
                var r,
                  n = this,
                  s = new RegExp(i.regex.source, (i.regex.flags || "") + "g"),
                  o = -1,
                  a = function () {
                    var a =
                    ...
                    i.validationCallback
                      ? i.validationCallback(a, function (e) {
                          n._rowsTimeoutId ||
                            (e &&
                              n._addLink(
                                l[1],
            ...
            (e.prototype._addLink = function (e, t, i, n, s) {
              ...
              if (this._mouseZoneManager && this._element) {
                ...
                (0 === u && ((u = this._bufferService.cols), f--),
                  this._mouseZoneManager.add(
                    new o(
                      ...
                      function () {
                        (a._onLinkHover.fire(
                          a._createLinkHoverEvent(l, h, u, f, s),
                        ),
                          a._element.classList.add("xterm-cursor-pointer"));
                      },
                      function (e) {
                        (a._onLinkTooltip.fire(
                          a._createLinkHoverEvent(l, h, u, f, s),
                        ),
                          n.hoverTooltipCallback &&
                            n.hoverTooltipCallback(e, i, {
                              start: { x: l, y: h },
                              end: { x: u, y: f },
                            }));
                      },
                      function () {
                        (a._onLinkLeave.fire(
                          ...
                          a._element.classList.remove("xterm-cursor-pointer"),
            ...
            Object.defineProperty(e.prototype, "selectionText", {
              get: function () {
                ...
                if (3 === this._activeSelectionMode) {
                  ...
                  if (e[1] !== t[1]) {
                    ((c = i.lines.get(t[1])),
                      (o = i.translateBufferLineToString(t[1], !0, 0, t[0])));
                    c && c.isWrapped ? (r[r.length - 1] += o) : r.push(o);
                  }
                }
                return r
              ...
              if ((e.stopImmediatePropagation(), this._model.selectionStart)) {
                ...
                if (
                  ...
                  if (this._model.selectionEnd[1] < i.lines.length) {
                    ...
                    r &&
                      0 === r.hasWidth(this._model.selectionEnd[0]) &&
                      this._model.selectionEnd[0]++;
                  }
                  (t &&
            ...
            (e.prototype._onMouseUp = function (e) {
              ...
              if (
                ...
                if (
                  ...
                  var i = this._mouseService.getCoords(
                    e,
                    this._element,
                    this._bufferService.cols,
                    this._bufferService.rows,
              ...
              if (
                ...
                if (s) {
                  var o = n.translateBufferLineToString(e[1], !1),
                    a = this._convertViewportColToCharacterIndex(s, e),
                    c = a,
                    l = e[0] - a,
                    h = 0,
                    u = 0,
                  ...
                  if (t || "" !== o.slice(a, c).trim()) {
                    ...
                    if (
                      ...
                      32 !== s.getCodePoint(this._bufferService.cols - 1)
                    ) {
    ...
    function (e, t, i) {
      ...
      function n(e, t, i, r) {
        ...
        return h(
          Math.abs(n - o) -
            (function (e, t, i) {
              for (
                var r = 0, n = e - s(i, e), o = t - s(i, t), c = 0;
                c < Math.abs(n - o);
                c++
              ) {
                var l = "A" === a(e, t) ? -1 : 1,
                  h = i.buffer.lines.get(n + l * c);
                h && h.isWrapped && r++;
              }
              return r;
            })(e, t, i),
      ...
      function s(e, t) {
        for (
          var i = 0, r = e.buffer.lines.get(t), n = r && r.isWrapped;
          n && t >= 0 && t < e.rows;
        )
          (i++, (n = (r = e.buffer.lines.get(--t)) && r.isWrapped));
        return i;
      }
      function o(e, t, i, r, o, a) {
        var c;
        return (
          (c = n(i, r, o, a).length > 0 ? r - s(o, r) : t),
          (e < i && c <= r) || (e >= i && c < r) ? "C" : "D"
        );
      }
      function a(e, t) {
      ...
      function c(e, t, i, r, n, s) {
        for (var o = e, a = t, c = ""; o !== i || a !== r; )
          ((o += n ? 1 : -1),
            n && o > s.cols - 1
              ? ((c += s.buffer.translateBufferLineToString(a, !1, e, o)),
                (o = 0),
                (e = 0),
                a++)
              : !n &&
                o < 0 &&
                ((c += s.buffer.translateBufferLineToString(a, !1, 0, e + 1)),
                (e = o = s.cols - 1),
                a--));
        ...
        u = (function (e) {
          function t(t, i, r, n, s) {
            ...
            return (
              ...
              (o._bufferService = r),
              (o._mouseService = n),
              (o._selectionService = s),
              (o._zones = []),
              (o._areZonesActive = !1),
              (o._lastHoverCoords = [void 0, void 0]),
              (o._initialSelectionLength = 0),
              o.register(
                c.addDisposableDomListener(
                  o._element,
                  "mousedown",
          ...
          return (
            ...
            (t.prototype._onHover = function (e) {
              ...
              i !== this._currentZone &&
                ...
                i &&
                  ((this._currentZone = i),
                  i.hoverCallback && i.hoverCallback(e),
            ...
            (t = s(
              [
                o(2, h.IBufferService),
                o(3, l.IMouseService),
                o(4, l.ISelectionService),
              ],
              t,
            ))
          );
      ...
      var s = i(16),
        ...
        u = (function (e) {
          function t(t, i) {
            ...
            return (
              (r._topBoundaryFocusListener = function (e) {
                return r._onBoundaryFocus(e, 0);
              }),
              (r._bottomBoundaryFocusListener = function (e) {
                return r._onBoundaryFocus(e, 1);
              }),
              r._rowElements[0].addEventListener(
                "focus",
                r._topBoundaryFocusListener,
              ),
              r._rowElements[r._rowElements.length - 1].addEventListener(
                "focus",
                r._bottomBoundaryFocusListener,
              ),
              r._refreshRowsDimensions(),
              r._accessibilityTreeRoot.appendChild(r._rowContainer),
              (r._renderRowsDebouncer = new a.RenderDebouncer(
                r._renderRows.bind(r),
              )),
              r._refreshRows(),
              ...
              r._terminal.element.insertAdjacentElement(
                "afterbegin",
                r._accessibilityTreeRoot,
              ),
              r.register(r._renderRowsDebouncer),
              r.register(
                r._terminal.onResize(function (e) {
                  return r._onResize(e.rows);
                }),
              ),
              r.register(
                r._terminal.onRender(function (e) {
                  return r._refreshRows(e.start, e.end);
                }),
              ),
              r.register(
                r._terminal.onScroll(function () {
                  return r._refreshRows();
                }),
              ),
              r.register(
                r._terminal.onA11yChar(function (e) {
                  return r._onChar(e);
                }),
              ),
              r.register(
                r._terminal.onLineFeed(function () {
                  return r._onChar("\n");
                }),
              ),
              r.register(
                r._terminal.onA11yTab(function (e) {
                  return r._onTab(e);
                }),
              ),
              r.register(
                r._terminal.onKey(function (e) {
                  return r._onKey(e.key);
                }),
              ),
              r.register(
                r._terminal.onBlur(function () {
                  return r._clearLiveRegion();
                }),
              ),
              r.register(
                r._renderService.onDimensionsChange(function () {
        ...
        f = (function (e) {
          function t(t, i, r, n) {
            ...
            return (
              (o._terminal = t),
              (o._colors = i),
              (o._charSizeService = r),
              (o._optionsService = n),
              (o._terminalClass = u++),
              (o._rowElements = []),
              (o._rowContainer = document.createElement("div")),
              o._rowContainer.classList.add(l),
              (o._rowContainer.style.lineHeight = "normal"),
              o._rowContainer.setAttribute("aria-hidden", "true"),
              o._refreshRowElements(o._terminal.cols, o._terminal.rows),
              (o._selectionContainer = document.createElement("div")),
              o._selectionContainer.classList.add(h),
              o._selectionContainer.setAttribute("aria-hidden", "true"),
              (o.dimensions = {
                scaledCharWidth: null,
                scaledCharHeight: null,
                scaledCellWidth: null,
              ...
              o._updateDimensions(),
              o._injectCss(),
              (o._rowFactory = new s.DomRendererRowFactory(
                document,
                o._optionsService,
              )),
              o._terminal.element.classList.add(c + o._terminalClass),
              o._terminal.screenElement.appendChild(o._rowContainer),
              o._terminal.screenElement.appendChild(o._selectionContainer),
              o._terminal.linkifier.onLinkHover(function (e) {
          ...
          return (
            n(t, e),
            (t.prototype.dispose = function () {
              (this._terminal.element.classList.remove(c + this._terminalClass),
            ...
            (t.prototype._injectCss = function () {
              ...
              ((t +=
                ...
                " { font-style: italic;}"),
                (t +=
                  "@keyframes blink_box_shadow { 50% {  box-shadow: none; }}"),
                (t +=
                  "@keyframes blink_block { 0% {  background-color: " +
                ...
                (t +=
                  ...
                  ";}"),
                this._colors.ansi.forEach(function (i, r) {
                  t +=
                    e._terminalSelector +
                    " .xterm-fg-" +
                    r +
            ...
            (t.prototype.renderRows = function (e, t) {
              for (
                ...
                a.innerHTML = "";
                var c = o + i.buffer.ydisp,
                  l = i.buffer.lines.get(c),
    ...
    function (e, t, i) {
      ...
      var a = (function () {
        ...
        return (
          (e.prototype.createRow = function (e, i, o, a, c, l, h) {
            for (
              var u = this._document.createDocumentFragment(),
                f = 0,
                _ = Math.min(e.length, h) - 1;
              _ >= 0;
              _--
            )
              if (
                e.loadCell(_, this._workCell).getCode() !== s.NULL_CELL_CODE ||
                (i && _ === a)
              ) {
                f = _ + 1;
                break;
            ...
            for (_ = 0; _ < f; _++) {
              ...
              if (0 !== d) {
                ...
                if ((d > 1 && (p.style.width = l * d + "px"), i && _ === a))
                  switch (
                    (p.classList.add(t.CURSOR_CLASS),
                    c && p.classList.add(t.CURSOR_BLINK_CLASS),
                    o)
                  ) {
                    case "bar":
                ...
                (this._workCell.isBold() && p.classList.add(t.BOLD_CLASS),
                  this._workCell.isItalic() && p.classList.add(t.ITALIC_CLASS),
                  this._workCell.isDim() && p.classList.add(t.DIM_CLASS),
                  this._workCell.isUnderline() &&
                    p.classList.add(t.UNDERLINE_CLASS),
                  (p.textContent =
                    this._workCell.getChars() || s.WHITESPACE_CELL_CHAR));
                ...
                if (this._workCell.isFgRGB()) {
                  ...
                  (this._workCell.isBold() &&
                    ...
                    this._optionsService.options.drawBoldTextInBrightColors &&
                    (y += 8),
                    p.classList.add("xterm-" + (v ? "b" : "f") + "g-" + y));
                } else
                  v && p.classList.add("xterm-bg-" + r.INVERTED_DEFAULT_COLOR);
                if (this._workCell.isBgRGB()) {
                  ...
                  this._workCell.isBgPalette()
                    ...
                    : v &&
                      p.classList.add("xterm-fg-" + r.INVERTED_DEFAULT_COLOR);
                u.appendChild(p);
              }
            }
            return u;
      ...
      t.evaluateKeyboardEvent = function (e, t, i, s) {
        ...
        switch (e.keyCode) {
          ...
          case 37:
            if (e.metaKey) break;
            a
              ? ((o.key = r.C0.ESC + "[1;" + (a + 1) + "D"),
                o.key === r.C0.ESC + "[1;3D" &&
                  (o.key = r.C0.ESC + (i ? "b" : "[1;5D")))
              : (o.key = t ? r.C0.ESC + "OD" : r.C0.ESC + "[D");
            break;
          case 39:
            if (e.metaKey) break;
            a
              ? ((o.key = r.C0.ESC + "[1;" + (a + 1) + "C"),
                o.key === r.C0.ESC + "[1;3C" &&
                  (o.key = r.C0.ESC + (i ? "f" : "[1;5C")))
              : (o.key = t ? r.C0.ESC + "OC" : r.C0.ESC + "[C");
            break;
          case 38:
            if (e.metaKey) break;
            a
              ? ((o.key = r.C0.ESC + "[1;" + (a + 1) + "A"),
                i ||
                  o.key !== r.C0.ESC + "[1;3A" ||
                  (o.key = r.C0.ESC + "[1;5A"))
              : (o.key = t ? r.C0.ESC + "OA" : r.C0.ESC + "[A");
              ...
              if ((i && !s) || !e.altKey || e.metaKey)
                i && !e.altKey && !e.ctrlKey && e.metaKey
                  ...
                  : e.key &&
                      ...
                      1 === e.key.length
                    ? (o.key = e.key)
                    : e.key && e.ctrlKey && "_" === e.key && (o.key = r.C0.US);
              else {
                var c = n[e.keyCode],
                  l = c && c[e.shiftKey ? 1 : 0];
                if (l) o.key = r.C0.ESC + l;
    ...
    function (e, t, i) {
      ...
      t.applyWindowsMode = function (e) {
        return e.onLineFeed(function () {
          var t = e.buffer.lines
            .get(e.buffer.ybase + e.buffer.y - 1)
            .get(e.cols - 1);
          e.buffer.lines.get(e.buffer.ybase + e.buffer.y).isWrapped =
        ...
        d = (function (e) {
          function t(t, i, r, n, s) {
            ...
            if (
              ...
              (o.charSizeService = s),
              (o._isPaused = !1),
              (o._needsFullRefresh = !1),
              (o._canvasWidth = 0),
              (o._canvasHeight = 0),
              (o._onDimensionsChange = new c.EventEmitter()),
              (o._onRender = new c.EventEmitter()),
              (o._onRefreshRequest = new c.EventEmitter()),
              (o._renderDebouncer = new a.RenderDebouncer(function (e, t) {
                return o._renderRows(e, t);
              })),
              o.register(o._renderDebouncer),
              (o._screenDprMonitor = new h.ScreenDprMonitor()),
              o._screenDprMonitor.setListener(function () {
                return o.onDevicePixelRatioChange();
              }),
              o.register(o._screenDprMonitor),
              o.register(
    ...
    function (e, t, i) {
      ...
      var o = ["cols", "rows"],
        a = (function () {
          function e(e) {
            var i = this;
            ((this._onOptionChange = new r.EventEmitter()),
              (this.options = s.clone(t.DEFAULT_OPTIONS)),
          ...
          return (
            ...
            (e.prototype.setOption = function (e, i) {
              ...
              this.options[e] !== i &&
                ...
                this.options[e] !== i &&
                  ((this.options[e] = i), this._onOptionChange.fire(e)));
            }),
        ...
        a = (function () {
          function e(e, t, i) {
            ((this.document = e),
              ...
              (this.width = 0),
              (this.height = 0),
              (this._onCharSizeChange = new o.EventEmitter()),
      ...
      var a = (function () {
        function e(e) {
          ((this._optionsService = e),
            ...
            (this.buffers = new o.BufferSet(e, this)));
        }
        return (
          Object.defineProperty(e.prototype, "buffer", {
            get: function () {
        ...
        s = (function () {
          function e(e, t) {
            ((this.optionsService = e),
              ...
              (this._normal = new r.Buffer(!0, e, t)),
              this._normal.fillViewportRows(),
              (this._alt = new r.Buffer(!1, e, t)),
      ...
      var h = (function () {
        function e(e, t, i) {
          ((this._hasScrollback = e),
            ...
            (this.markers = []),
            (this._nullCell = s.CellData.fromCharData([
              0,
              o.NULL_CELL_CHAR,
              o.NULL_CELL_WIDTH,
              o.NULL_CELL_CODE,
            ])),
            (this._whitespaceCell = s.CellData.fromCharData([
              0,
        ...
        return (
          ...
          (e.prototype.resize = function (e, t) {
            var i = this.getNullCell(n.DEFAULT_ATTR_DATA),
          ...
          Object.defineProperty(e.prototype, "_isReflowEnabled", {
            get: function () {
              return (
                this._hasScrollback && !this._optionsService.options.windowsMode
              );
            },
            enumerable: !0,
            configurable: !0,
          ...
          (e.prototype._reflowLarger = function (e, t) {
            var i = a.reflowLargerGetLinesToRemove(
              this.lines,
              this._cols,
              e,
              this.ybase + this.y,
          ...
          (e.prototype._reflowSmaller = function (e, t) {
            for (
              var i = this.getNullCell(n.DEFAULT_ATTR_DATA),
                r = [],
                s = 0,
                o = this.lines.length - 1;
              o >= 0;
              o--
            ) {
              var c = this.lines.get(o);
              if (!(!c || (!c.isWrapped && c.getTrimmedLength() <= e))) {
                for (var l = [c]; c.isWrapped && o > 0; )
                  ((c = this.lines.get(--o)), l.unshift(c));
                ...
                if (!(h >= o && h < o + l.length)) {
                  ...
                  d =
                    0 === this.ybase && this.y !== this.lines.length - 1
                      ...
                      : Math.max(
                          0,
                          this.lines.length - this.lines.maxLength + _,
                        );
                  for (var p = [], v = 0; v < _; v++) {
                  ...
                  (p.length > 0 &&
                    (r.push({ start: o + l.length + s, newLines: p }),
                    (s += p.length)),
                    l.push.apply(l, p));
                  var y = f.length - 1,
                    m = f[y];
                  ...
                  for (var b = l.length - _ - 1, C = u; b >= 0; ) {
                    var S = Math.min(C, m);
                    if (
                      (l[y].copyCellsFrom(l[b], C - S, m - S, S, !0),
                      0 === (m -= S) && (m = f[--y]),
                      0 === (C -= S))
                    ) {
                      b--;
            ...
            if (r.length > 0) {
              ...
              var R = 0;
              for (
                v = Math.min(this.lines.maxLength - 1, x + s - 1);
                v >= 0;
                v--
              )
                if (T && T.start > k + R) {
                  for (var M = T.newLines.length - 1; M >= 0; M--)
                    this.lines.set(v--, T.newLines[M]);
                  (v++,
                    L.push({ index: k + 1, amount: T.newLines.length }),
                    (R += T.newLines.length),
                    (T = r[++D]));
          ...
          (e.prototype.stringIndexToBufferIndex = function (e, t, i) {
            for (void 0 === i && (i = !1); t; ) {
              ...
              for (
                ...
                if (
                  (r.get(s)[o.CHAR_DATA_WIDTH_INDEX] &&
                    (t -= r.get(s)[o.CHAR_DATA_CHAR_INDEX].length || 1),
                  t < 0)
                )
                  return [e, s];
              e++;
    ...
    function (e, t, i) {
      ...
      var r = i(1),
        n = (function () {
          function e(e) {
            ((this._maxLength = e),
              (this.onDeleteEmitter = new r.EventEmitter()),
              (this.onInsertEmitter = new r.EventEmitter()),
              (this.onTrimEmitter = new r.EventEmitter()),
    ...
    function (e, t, i) {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.reflowLargerGetLinesToRemove = function (e, t, i, n, s) {
            ...
            if (l.isWrapped) {
              ...
              if (n >= a && n < c) a += h.length - 1;
                ...
                for (
                  ...
                  m++;
                (m > 0 && (o.push(a + h.length - m), o.push(m)),
                  (a += h.length - 1));
              }
            }
          }
        ...
        o = (function (e) {
          function t(i) {
            ...
            return (
              ...
              (r._id = t._nextId++),
              (r.isDisposed = !1),
              (r._onDispose = new s.EventEmitter()),
              r
            );
          }
          return (
    ...
    function (e, t, i) {
      ...
      var s = i(5),
        ...
        a = (function () {
          ...
          return (
            (e.prototype.getCoords = function (e, t, i, r, n) {
              return o.getCoords(
                e,
                t,
                i,
    ...
    function (e, t, i) {
      ...
      var s = i(0),
        o = i(1),
        a = i(31),
        c = Object.freeze({ applicationCursorKeys: !1 }),
        l = (function () {
          function e(e, t, i, r) {
            ((this._scrollToBottom = e),
              ...
              (this._logService = i),
              (this._optionsService = r),
              (this._onData = new o.EventEmitter()),
              (this._onUserInput = new o.EventEmitter()),
          ...
          return (
            ...
            (e.prototype.triggerDataEvent = function (e, t) {
              if (
                ...
                var i = this._bufferService.buffer;
                (i.ybase !== i.ydisp && this._scrollToBottom(),
          ...
          return (
            ...
            (e.prototype._log = function (e, t, i) {
              (this._evalLazyOptionalParams(i),
                e.call.apply(e, s([console, "xterm.js: " + t], i)));
            }),
        ...
        return (
          ...
          (e.prototype.createInstance = function (e) {
            for (var t = [], i = 1; i < arguments.length; i++)
              t[i - 1] = arguments[i];
            for (
              var n = s.getServiceDependencies(e).sort(function (e, t) {
        ...
        u = (function () {
          function e(e, t) {
            ...
            ((this._bufferService = e),
              ...
              (this._onProtocolChange = new o.EventEmitter()),
        ...
        return (
          ...
          (e.prototype._innerWrite = function () {
            for (
              ...
              var i = this._writeBuffer[this._bufferOffset],
                r = this._callbacks[this._bufferOffset];
              if (
                (this._bufferOffset++,
                this._action(i),
