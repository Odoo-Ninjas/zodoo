...
export const BindingActions = {
  ...
  UNBIND_INPUT_FROM_SCREEN:
    "UNBIND_INPUT_FROM_SCREEN" as "UNBIND_INPUT_FROM_SCREEN",
  UNBIND_SOURCE_FROM_SCREEN:
    "UNBIND_SOURCE_FROM_SCREEN" as "UNBIND_SOURCE_FROM_SCREEN",
  UNBIND_STREAM_FROM_SCREEN:
    "UNBIND_STREAM_FROM_SCREEN" as "UNBIND_STREAM_FROM_SCREEN",
};
...
export type BindingActionTypes =
  | BindInputToScreenAction
